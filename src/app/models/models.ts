    ...
    this.orderProducts = [
      {
        ...
        productQuantity: 1,
        productDiscount: 0.2,
        productPrice: this.products.find(o => o.id == "1").salesPrice,
        subTotal: 100,
      },
      {
        idOrder: this.orders.find(o => o.id == "1"),
        ...
        productQuantity: 1,
        productDiscount: 0.5,
        productPrice: this.products.find(o => o.id == "2").salesPrice,
        subTotal: 100,
      },
      {
        idOrder: this.orders.find(o => o.id == "1"),
        ...
        productPrice: this.products.find(o => o.id == "3").salesPrice,
        subTotal: 100,
      },
    ];
  }
